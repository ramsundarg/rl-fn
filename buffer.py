# -*- coding: utf-8 -*-
"""
Created on Tue Mar 29 14:50:19 2022
...
class BasicBuffer_a:
    ...
    def sample(self, batch_size=32):
        ...
        #return (tf.convert_to_tensor(temp_dict['s'],tf.float32),tf.convert_to_tensor(temp_dict['a'],tf.float32),tf.convert_to_tensor(temp_dict['r'].reshape(-1,1),tf.float32),tf.float32),tf.convert_to_tensor(temp_dict['s2'],tf.convert_to_tensor(temp_dict['d'],tf.float32))
