...
async def handle_data(request: Request):
    ...
    try :
        ...
        return templates.TemplateResponse("index.html", {"request": request,"id" : "Deployed experiment at : http://127.0.0.1:5000/#/experiments/{}/runs/{}".format(int(e.experiment_id),r)})
    
    except Exception as e:
      return templates.TemplateResponse("index.html", {"request": request,"id" : str(e)})
    #run_experiment(cfg)
    # your code
    # return a response
